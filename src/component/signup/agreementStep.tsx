   ...
   <div className='contentWrap'>
    <Form onSubmit={handleSubmit}> 
      <div className='inputTitle'>개인정보수집동의</div>
        <div>
         <label>
           <input type="checkbox" checked={personalInfoAgree} onChange={() => setPersonalInfoAgree(!personalInfoAgree)} />
           개인정보 수집에 동의합니다.
         </label>
         </div>
      <div className='inputTitle'>위치정보수집동의</div>
        <div>
         <label>
           <input type="checkbox" checked={locationInfoAgree} onChange={() => setLocationInfoAgree(!locationInfoAgree)} />
           위치 정보 수집에 동의합니다.
         </label>
        </div>        
      <Button className='centerButton' type="default" onClick={() => goToMain()}>
        회원가입 취소
      </Button>
      {isAllChecked()&&<Button className='bottomButton' type="primary" onClick={() => handleSubmit()}>
        다음으로
      </Button>}
     </Form>
   </div> 
